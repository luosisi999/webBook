...
# <a id="修改输出资源的名称和路径">六、修改输出资源的名称和路径</a>
...
# <a id="自动清空上次打包资源">七、自动清空上次打包资源</a>
